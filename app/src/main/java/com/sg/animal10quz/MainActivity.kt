...
import com.sg.animal10quz.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        PreferenceManager.setDefaultValues(this@MainActivity, R.xml.quiz_preferences, false)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
       ...
       /* return when (item.itemId) {
        ...
        val preferencesIntent = Intent(this@MainActivity, SettingActivity::class.java)
